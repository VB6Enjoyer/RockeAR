...
<head>
	...
	<title>RockeAR | Añadir un artista</title>
	 	...
	 	============================================-->
		 	...
		 	<div class="agregar">
		 		<style>
					...
					<div class="center">
						<form action="crearBanda.php" method="post" id="banda-form" enctype="multipart/form-data" >
							<b>Nombre del artista:*</b><br>
							<input type="text" id="nombre" placeholder="Nombre" name="nombre" maxlength="255" required>
							<p style="font-size:14px;margin:5px"><i>Debe ser el nombre oficial del artista.</i></p><br>
							<b>Apodo/Acrónimo:</b> <br>
							<input type="text" id="apodo" placeholder="Apodos" name="apodo" maxlength="64">
							<p style="font-size:14px;margin:5px"><i>Debe ser usado por el artista o sus fans.</i></p><br>
							<b>Género:*</b> <br>
							<input type="text" id="genero" placeholder="Género" name="genero" maxlength="32" required>
							<p style="font-size:14px;margin:5px"><i>Tiene que ser específico y objetivo.</i></p><br>
							<b>Localidad:</b> <br>
							<input type="text" id="localidad" placeholder="Localidad" name="localidad" maxlength="64">
							<p style="font-size:14px;margin:5px"><i>Ciudad/Pueblo y/o Provincia</i></p><br>
							<b>Actividad:</b> <br>
							<input type="text" id="actividad" placeholder="Actividad" name="actividad" maxlength="64">
							<p style="font-size:14px;margin:5px"><i>Entre y/o desde cuando está/estuvo activo el artista.</i></p><br>
							<b>Descripción/Biografía:</b> <br>
							...
							<b>Imegen de la banda:</b> <br>
							<input id="art-img" name="art-img" type="file" accept="image/png, image/jpeg" required><br>
					    <span id="error-img"></span>
							<br>
							<b>YouTube:*</b><br>
							<input type="text" id="video" placeholder="URL" name="video" maxlength="64" style="display:inline" required>
							<p style="font-size:14px;margin:5px"><i>URL a un video de YouTube con una canción del artista.</i></p><br>
							<b>Pagina Web:</b><br>
							<input type="text" id="paginaweb" name="paginaweb"><br><br>
							<p style="font-size:14px;margin:5px"><i>Link a la web del artista.</i></p><br>
							<b>Facebook:</b><br>
							<input type="text" id="facebook" placeholder="Facebook" name="facebook" maxlength="64" style="display:inline">
							<p style="font-size:14px;margin:5px"><i>Página de Facebook del artista.</i></p><br>
							<b>Instagram:</b><br>
							<input type="text" id="instagram" placeholder="Instagram" name="instagram" maxlength="64" style="display:inline">
							<p style="font-size:14px;margin:5px"><i>Página de Instagram del artista.</i></p><br>
							...
							<input type="submit" value="Añadir Artista" class="btn btn-outline-dark"> <br> <br>
							<p style="font-size:14px;margin:5px"><i>Los campos marcados con <b>*</b> son obligatorios</i></p>
						</form>
					</div>
				</div>	 	
		 	
	 	<!---=====  End of FORM AGREGAR ARTISTA  ======-->
		 
		 
		<!---=====  Scripts  ======-->
		<script src="js/uploadImgVer.js"></script>
		<!---=====  End of Scripts  ======-->
