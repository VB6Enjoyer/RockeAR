	...
	<body style="background-color: lightblue; color: #ffffff" >
		...
		=======================================-->
			...
			<div class="bandadestacada">
				...
				<h1>BANDA DESTACADA</h1>
				<h2><?= $bandaAleatoria["nombre"] ?></h2> <br>
				<iframe width="560" height="315" src="<?= $bandaAleatoria["video"] ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><!-- cambie para que muestre el video con el codigo del video -->
			</div>		
		
		<!--=====  End of BANDA DESTACADA  ======-->
	</body>
</html>