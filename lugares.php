	...
	<body style="background-color: lightblue; color: #ffffff" >
		...
		=====================================-->
		 	...
		 	<div class="listalugares">
				...
				<a href="agregarlugar.php" class="badge badge-info"><h5>Agregar un lugar</h5></a><br><br>
				<?php foreach($lugares as $lugar): ?>
					<h3>
						<a href="lugar.php?id=<?php echo $lugar['id']; ?>" class="list-group-item list-group-item-action list-group-item-primary"><?php echo $lugar['nombre']; ?></a>
					</h3>
				<?php endforeach;?>
		 	</div>		
		
		<!--=====  End of LISTA LUGARES  ======-->
