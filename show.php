...
<head>
	...
	<title>RockeAR | Show - <?php echo $show["nombre"] ?></title>
			...
			<div class="redes">
				<style type="text/css">
					...
					.social li a { /*Diseño de la lista de iconos*/
						...
						line-height: 30px; /*Distancia entre iconos*/
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6">
								<h1><?php echo $show["nombre"] ?></h1>
								<h5>
									<?php if($show["organizador"] != ""){
										echo "<em>" . $show["organizador"] . "</em>";}?> <br>
										FLYER<br><br>
									</h5>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6">
									<ul class="show2">
										<li><strong>LUGAR: </strong><?php echo $show["lugar"]?></li>
										<li><strong>FECHA Y HORARIO: </strong><?php echo $show["fecha"];?> desde las <?php echo $show["horario"];?></li>
										<li><strong>ARTISTAS: </strong><?php echo $show["artistas"]?></li>
									</ul>
								</div>
							</div>          	
						</div>
						<div class="show3">
							<?php echo $show["descripcion"]?>
						</div>
					</section>
				</div>		
