...
<head>
	...
	<title>RockeAR | Shows y Eventos</title>
		...
		===================================-->
			...
			<div class="listashows">
				<style>
					...
					<a href="agregarshow.php" class="badge badge-info"><h5>Agregar un show</h5></a><br><br>
					<?php foreach($shows as $evento): ?>
						<div>
							<h3>
								<a href="show.php?id=<?php echo $evento['id']; ?>" class="list-group-item list-group-item-action list-group-item-primary"><?php echo $evento['nombre']; ?></a>
							</h3>
						</div>
					<?php endforeach;?>		
			</div>		
